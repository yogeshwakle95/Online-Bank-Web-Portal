    ...
    <div className='container56'>
      ...
      <div className='ent1'>
        ...
        <div className='button-container1-56'>
          <button className='btn1' onClick={handleWithdraw}>Deposit</button>
          <button  className='btn2'><Link to={'/depositTransaction'} style={{textDecoration:"none",color:"white"}} >View Transaction</Link></button>
        </div>
      </div>
    </div>
