...
const fun=async(e)=>{
  ...
  if(info.amount == 0  || info.amount === null  || info.amount === ''  || info.amount === undefined){
...
<hr className='hr11'></hr>
        ...
        <div className='cnt-9'>
            <div className='cnt-6'>
                    Enter Recepient Name <span style={{color:"red"}}>*</span>
            </div>
       ...
       {!hook && userAccountData?.filter((r)=>r.isApproved == "true").map((e,i)=>
        ...
        <div className='cnt-11'>
          <div className='cnt-10'>Enter Amount<span style={{color:"red"}}>*</span></div>
